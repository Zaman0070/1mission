...
class AdminChatStream extends StatefulWidget {
  final String chatRoomId;

  AdminChatStream({this.chatRoomId});

  @override
  State<AdminChatStream> createState() => _AdminChatStreamState();
}

class _AdminChatStreamState extends State<AdminChatStream> {
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if (date == today) {
                          lastChatDate = DateFormat('hh:mm').format(
                              DateTime.fromMicrosecondsSinceEpoch(snapshot.data.docs[index]['time']));
                        } else {
