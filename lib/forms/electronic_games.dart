...
class ElectronicGamesForm extends StatefulWidget {
  @override
  _ElectronicGamesFormState createState() => _ElectronicGamesFormState();
}

class _ElectronicGamesFormState extends State<ElectronicGamesForm> with TickerProviderStateMixin {
                          ...
                          child: Padding(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                if(brandController.text == 'other Game')
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(
                                          ...
                                          onTap: () {
                                            smalBottomSheet(
                                               // fieldValue: 'Choose Area',
                                                list: area(context),textController: areaController);
                                          },
                                          child: Container(
                                            height: 6.h,
                                            width: 30.w,
