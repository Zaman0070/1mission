...
import 'package:marketplace_app/image_piker_motor.dart';
...
class MotorcyclesForms extends StatefulWidget {
  @override
  State<MotorcyclesForms> createState() => _MotorcyclesFormsState();
}

class _MotorcyclesFormsState extends State<MotorcyclesForms>  with TickerProviderStateMixin{
  ...
  int langIndex = 0;
  String a, at, t, f, ti, con, gur, col, k;
  valid() {
    if (a.isEmpty ||
        at.isEmpty ||
        t.isEmpty ||
    ...
    if (formKey.currentState.validate()) {
      if (provider.urlList.isNotEmpty) {
        provider.dataToFireStore.addAll({
          ...
          'noOfOwners': noOfOwnerController.text,
  ...
  List<String> noOfOwner = ['1', '2', '3', '4', '4+ '];
  ...
  void didChangeDependencies() {
    ...
    setState(() {
      ...
      yearController.text = catProvider.dataToFireStore.isEmpty
          ? null
          : catProvider.dataToFireStore['year'];
      ...
      noOfOwnerController.text = catProvider.dataToFireStore.isEmpty
          ? null
  ...
  Widget build(BuildContext context) {
    ...
    //                       },
    //                       child: Text(translate('cancel'),style: TextStyle(color: Colors.white),),
    //                     ),
    //                     SizedBox(
    //                       width: 10,
    //                     ),
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                contentPadding:
                                                EdgeInsets.symmetric(horizontal: 8),
                                                hintText: 'Choose Motorcycle type',
                                                hintStyle: TextStyle(color: Colors.black),
                                                border: InputBorder.none,
                                              ),
                                            ),
                                    ...
                                    if(brandController.text == 'other Bick')
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(
