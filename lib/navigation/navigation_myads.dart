...
class NavigationMyAdd extends StatefulWidget {

  @override
  _NavigationMyAddState createState() => _NavigationMyAddState();
}

class _NavigationMyAddState extends State<NavigationMyAdd> {
  bool isSigned = false;
